...
let
  nixifiedLockHash = "1bde51bfc7136639739402d55d858ff9f64c19fc623ca6c3bc62efc146a56f7d";
...
in
{
  ...
  workspace = {
    tui_chat_server = rustPackages.unknown.tui_chat_server."0.1.0";
  };
  "unknown".tui_chat_server."0.1.0" = overridableMkRustCrate (profileName: rec {
    name = "tui_chat_server";
    version = "0.1.0";
    registry = "unknown";
